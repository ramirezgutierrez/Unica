...
public class ActualizarProveedor extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ActualizarProveedor frame = new ActualizarProveedor();
	...
	public ActualizarProveedor() {
		...
		JLabel lblAgregarProveedor = new JLabel("MODIFICAR PROVEEDOR");
		lblAgregarProveedor.setFont(new Font("SimSun", Font.BOLD | Font.ITALIC, 14));
		
		JLabel lblIntroducirIdDel = new JLabel("INTRODUCIR ID DEL PROVEEDOR");
		lblIntroducirIdDel.setFont(new Font("SimSun", Font.BOLD | Font.ITALIC, 14));
		...
		gl_panel.setHorizontalGroup(
			gl_panel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panel.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblIntroducirIdDel, GroupLayout.PREFERRED_SIZE, 229, GroupLayout.PREFERRED_SIZE)
					...
					.addGap(341)
					.addComponent(lblAgregarProveedor, GroupLayout.PREFERRED_SIZE, 182, GroupLayout.PREFERRED_SIZE)
			...
			gl_panel.createParallelGroup(Alignment.LEADING)
				...
				.addGroup(gl_panel.createSequentialGroup()
					.addGroup(gl_panel.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblIntroducirIdDel, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE)
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if (n==JOptionPane.YES_OPTION) {
				 ...
				 taobservaciones.setText(null);
					...
					ActualizarProveedor.this.dispose();
	...
	JTextField tfrazon=null;
	JTextField tfcorreo=null;
	JTextField tfdni=null;
	JTextField tfdireccion=null;
	JTextField tfpoblacion=null;
	JTextField tfciudad=null;
	JTextField tfpais=null;
	JTextField tfcp=null;
	JTextField tffax=null;
	JTextField tfntp=null;
	JTextField tfntp_1=null;
