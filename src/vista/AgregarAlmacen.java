...
public class AgregarAlmacen extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					AgregarAlmacen frame = new AgregarAlmacen();
	...
	public AgregarAlmacen() {
		...
		JLabel lblAgregarAlmacn = new JLabel("AGREGAR ALMAC\u00C9N");
